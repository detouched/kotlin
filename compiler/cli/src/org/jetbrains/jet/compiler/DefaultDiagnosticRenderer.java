...
public class DefaultDiagnosticRenderer implements DiagnosticRenderer<Diagnostic> {
    ...
    private DefaultDiagnosticRenderer() {
        ...
        factoryToRenderer.put(UNRESOLVED_REFERENCE, new SimpleDiagnosticRenderer("Unresolved reference"));

        factoryToRenderer.put(INVISIBLE_REFERENCE,
                              new DiagnosticWithParameters2Renderer<DeclarationDescriptor, DeclarationDescriptor>(
                                      "Cannot access ''{0}'' in ''{1}''", NAME, NAME));
        factoryToRenderer.put(INVISIBLE_MEMBER,
                              new DiagnosticWithParameters2Renderer<DeclarationDescriptor, DeclarationDescriptor>(
                                      "Cannot access ''{0}'' in ''{1}''", NAME, NAME));
        ...
        factoryToRenderer.put(TYPE_MISMATCH,
                              new DiagnosticWithParameters2Renderer<JetType, JetType>(
                                      "Type mismatch: inferred type is {1} but {0} was expected",
                                      RENDER_TYPE, RENDER_TYPE));
        factoryToRenderer.put(INCOMPATIBLE_MODIFIERS, new DiagnosticWithParameters1Renderer<Collection<JetKeywordToken>>(
                "Incompatible modifiers: ''{0}''",
        ...
        factoryToRenderer.put(REDUNDANT_MODIFIER, new DiagnosticWithParameters1Renderer<JetKeywordToken>("Illegal modifier ''{0}''", TO_STRING));
        ...
        factoryToRenderer.put(NAMED_PARAMETER_NOT_FOUND, new SimpleDiagnosticRenderer("Cannot find a parameter with this name"));
